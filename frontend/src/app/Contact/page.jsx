...
const Contact = () => {
  return (
    <section className="w-full min-h-screen bg-gradient-to-br from-gray-900 to-black py-20 px-6 flex justify-center items-center">
      <div className="max-w-4xl w-full bg-gray-800 rounded-lg shadow-xl p-8">
        ...
        <motion.div
          ...
          className="mt-8 flex flex-col md:flex-row justify-around text-gray-200"
        >
